<?php
		 ...
		 *
		 * @package			HOF\view\spo_apsl_users_social_profile_details_wb
		 * @version			1.0
		 * @uses
		 * @see
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_apsl_users_social_profile_details table and 
		 ...
		 * @modification
		 */
class spo_apsl_users_social_profile_details_wb{
...
$log_create->set_otherDetails(array('Mode'=>'spo_apsl_users_social_profile_details_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_apsl_users_social_profile_details/index/false/0/0/spo_apsl_users_social_profile_details_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_apsl_users_social_profile_details/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_apsl_users_social_profile_details/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_apsl_users_social_profile_details/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_apsl_users_social_profile_details/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_apsl_users_social_profile_details/delete/';
  ...
  var doDeleteForm = function (){ 
   ...
   var doDelete = function (){
      ...
      var search = wb.getSearch();           
      var prime_id= "id:"+search.grid.cells(search.grid.getSelectedId(),0).getValue();
  ...
  //wb.setGridDelCallback(doDeleteWithoutForm)   ;  
    ...
    //search should be updated by the developer depend on the req
       var mySearchColumns = [
          ...
          {type:"text", name: 'provider_name', id: 'provider_name', placeholder: 'provider_name!',size: '10',index: 2 }
