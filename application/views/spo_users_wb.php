<?php
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_users table and 
...
$log_create->set_otherDetails(array('Mode'=>'spo_users_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_users/index/false/0/0/spo_users_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_users/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_users/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_users/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_users/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_users/delete/';
  ...
  //wb.setGridDelCallback(doDeleteWithoutForm)   ;  
    ...
    //search should be updated by the developer depend on the req
       var mySearchColumns = [
          ...
          {type:"text", name: 'user_login', id: 'user_login', placeholder: 'user_login!',size: '10',index: 2 }
