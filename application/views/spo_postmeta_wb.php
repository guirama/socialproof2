<?php
		 ...
		 *
		 * @package			HOF\view\spo_postmeta_wb
		 * @version			1.0
		 * @uses
		 * @see
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_postmeta table and 
...
$log_create->set_otherDetails(array('Mode'=>'spo_postmeta_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_postmeta/index/false/0/0/spo_postmeta_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_postmeta/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_postmeta/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_postmeta/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_postmeta/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_postmeta/delete/';
