<?php
		 ...
		 *
		 * @package			HOF\view\spo_hof_banners_form 
		 * @version			1.0
		 * @uses
		 * @see
...
$banner_id	= isset($banner_id)? $banner_id : "";
$banner_id = isset($banner_id)? $banner_id: "";
$user_id = isset($user_id)? $user_id: "";
$hof_review_id = isset($hof_review_id)? $hof_review_id: "";
$url = isset($url)? $url: "";
$template_id = isset($template_id)? $template_id: "";
$created_on = isset($created_on)? $created_on: "";
$dfm_date = isset($dfm_date)? $dfm_date: "";
$tagline = isset($tagline)? $tagline: "";
$banner_created_on = isset($banner_created_on)? $banner_created_on: "";
...
$log_create->set_otherDetails(array('Mode'=>"spo_hof_banners_Form-$mode",'Data'=>$banner_id));
$log_create->init();


$fieldset_title ="Spo_hof_banners (".ucfirst($mode).")";
?>
...
<?
//Create new form
$myForm = new form_object('spo_hof_banners_form') ;
	...
	$myForm->formOpenTag = array('method' => 'post',
		...
		$id_field = new field('banner_id','hidden',array('value'=>$banner_id,'required_mark' => false));
...
$field_8 = new field(
	...
	$myForm->fieldSets = array(
			'tpdetails' => array(
					...
					'fields' =>  array(
							$id_field,
							$mode_field,$form_status_field,$field_0,$field_1,$field_2,$field_3,$field_4,$field_5,$field_6,$field_7,$field_8
							)
					)
	);
$myForm->init();
...
function inputValidate(){
	...
	idlist = Array('banner_id','user_id','hof_review_id','url','template_id','created_on','dfm_date','tagline','banner_created_on');
	iddis = Array('','','','','','','','','');
