<?php
		 ...
		 *
		 * @package			HOF\view\spo_yoast_seo_meta_form 
		 * @version			1.0
		 * @uses
		 * @see
...
$object_id = isset($object_id)? $object_id: "";
$internal_link_count = isset($internal_link_count)? $internal_link_count: "";
$incoming_link_count = isset($incoming_link_count)? $incoming_link_count: "";
...
$log_create->set_otherDetails(array('Mode'=>"spo_yoast_seo_meta_Form-$mode",'Data'=>$object_id));
$log_create->init();


$fieldset_title ="Spo_yoast_seo_meta (".ucfirst($mode).")";
?>
...
<?
//Create new form
$myForm = new form_object('spo_yoast_seo_meta_form') ;
	...
	$myForm->formOpenTag = array('method' => 'post',
		...
		$id_field = new field('object_id','hidden',array('value'=>$object_id,'required_mark' => false));
...
$field_2 = new field(
									'incoming_link_count',
									'text',array(
											'id'=>'incoming_link_count',
											'value'=>"$incoming_link_count",
											'label' => '',
											'required_mark' => TRUE,
											'style' => '',
											'field_msg'=>'',
...
function inputValidate(){
	...
	idlist = Array('object_id','internal_link_count','incoming_link_count');
	iddis = Array('','','');
