<?php
		 ...
		 *
		 *
		 * This is main view file of spo_admins management. 
		 *
		 * @package			HOF\view\spo_admins_view
		 * @version			1.0
		 * @uses
		 * @see
...
$log_create->set_otherDetails(array('Mode'=>'spo_admins_View','Data'=>'-'));
$log_create->init();
