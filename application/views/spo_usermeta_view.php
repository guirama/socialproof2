<?php
		 ...
		 *
		 *
		 * This is main view file of spo_usermeta management. 
		 *
		 * @package			HOF\view\spo_usermeta_view
		 * @version			1.0
		 * @uses
		 * @see
...
$log_create->set_otherDetails(array('Mode'=>'spo_usermeta_View','Data'=>'-'));
$log_create->init();
