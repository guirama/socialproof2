<?php
		 ...
		 *
		 * @package			HOF\view\spo_commentmeta_form 
		 * @version			1.0
		 * @uses
		 * @see
...
$log_create->set_otherDetails(array('Mode'=>"spo_commentmeta_Form-$mode",'Data'=>$meta_id));
$log_create->init();


$fieldset_title ="Spo_commentmeta (".ucfirst($mode).")";
?>
...
<?
//Create new form
$myForm = new form_object('spo_commentmeta_form') ;
...
function inputValidate(){
	...
	idlist = Array('meta_id','comment_id','meta_key','meta_value');
	iddis = Array('','','','');
