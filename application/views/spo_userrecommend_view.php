<?php
		 ...
		 *
		 *
		 * This is main view file of spo_userrecommend management. 
		 *
		 * @package			HOF\view\spo_userrecommend_view
		 * @version			1.0
		 * @uses
		 * @see
...
$log_create->set_otherDetails(array('Mode'=>'spo_userrecommend_View','Data'=>'-'));
$log_create->init();
