<?php
		 ...
		 *
		 * @package			HOF\view\spo_client_reviews_wb
		 * @version			1.0
		 * @uses
		 * @see
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_client_reviews table and 
...
$log_create->set_otherDetails(array('Mode'=>'spo_client_reviews_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_client_reviews/index/false/0/0/spo_client_reviews_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_client_reviews/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_client_reviews/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_client_reviews/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_client_reviews/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_client_reviews/delete/';
  ...
  //wb.setGridDelCallback(doDeleteWithoutForm)   ;  
    ...
    //search should be updated by the developer depend on the req
       var mySearchColumns = [
          ...
          {type:"text", name: 'review_id', id: 'review_id', placeholder: 'review_id!',size: '10',index: 2 }
