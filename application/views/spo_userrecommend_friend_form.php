<?php
		 ...
		 *
		 * @package			HOF\view\spo_userrecommend_friend_form 
		 * @version			1.0
		 * @uses
		 * @see
		 ...
		 * @modification
		 */
class spo_userrecommend_friend_form{
...
$friend_name = isset($friend_name)? $friend_name: "";
$friend_email = isset($friend_email)? $friend_email: "";
$friend_mobile = isset($friend_mobile)? $friend_mobile: "";
$ip = isset($ip)? $ip: "";
...
$log_create->set_otherDetails(array('Mode'=>"spo_userrecommend_friend_Form-$mode",'Data'=>$recommend_id));
$log_create->init();


$fieldset_title ="Spo_userrecommend_friend (".ucfirst($mode).")";
?>
...
<?
//Create new form
$myForm = new form_object('spo_userrecommend_friend_form') ;
...
$field_7 = new field(
	...
	$myForm->fieldSets = array(
			'tpdetails' => array(
					...
					'fields' =>  array(
							$id_field,
							$mode_field,$form_status_field,$field_0,$field_1,$field_2,$field_3,$field_4,$field_5,$field_6,$field_7
							)
					)
	);
$myForm->init();
...
function inputValidate(){
	...
	idlist = Array('recommend_id','user_id','name','friend_name','friend_email','friend_mobile','ip','date');
	iddis = Array('','','','','','','','');
