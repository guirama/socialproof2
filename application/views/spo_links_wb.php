<?php
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_links table and 
...
$log_create->set_otherDetails(array('Mode'=>'spo_links_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_links/index/false/0/0/spo_links_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_links/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_links/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_links/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_links/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_links/delete/';
  ...
  var doDeleteForm = function (){ 
   ...
   var doDelete = function (){
      ...
      var search = wb.getSearch();           
      var prime_id= "link_id:"+search.grid.cells(search.grid.getSelectedId(),0).getValue();
  ...
  //wb.setGridDelCallback(doDeleteWithoutForm)   ;  
    ...
    //search should be updated by the developer depend on the req
       var mySearchColumns = [
          ...
          {type:"text", name: 'link_url', id: 'link_url', placeholder: 'link_url!',size: '10',index: 2 }
