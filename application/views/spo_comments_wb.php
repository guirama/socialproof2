<?php
		 ...
		 *
		 * @package			HOF\view\spo_comments_wb
		 * @version			1.0
		 * @uses
		 * @see
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_comments table and 
...
$log_create->set_otherDetails(array('Mode'=>'spo_comments_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_comments/index/false/0/0/spo_comments_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_comments/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_comments/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_comments/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_comments/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_comments/delete/';
  ...
  var doDeleteForm = function (){ 
   ...
   var doDelete = function (){
      ...
      var search = wb.getSearch();           
      var prime_id= "comment_ID:"+search.grid.cells(search.grid.getSelectedId(),0).getValue();
  ...
  //wb.setGridDelCallback(doDeleteWithoutForm)   ;  
    ...
    //search should be updated by the developer depend on the req
       var mySearchColumns = [
          ...
          {type:"text", name: 'comment_author_email', id: 'comment_author_email', placeholder: 'comment_author_email!',size: '10',index: 2 }
