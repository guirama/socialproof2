<?php
		 ...
		 *
		 * @package			HOF\view\spo_clients_wb
		 * @version			1.0
		 * @uses
		 * @see
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_clients table and 
...
$log_create->set_otherDetails(array('Mode'=>'spo_clients_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_clients/index/false/0/0/spo_clients_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_clients/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_clients/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_clients/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_clients/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_clients/delete/';
  ...
  var doDeleteForm = function (){ 
   ...
   var doDelete = function (){
      ...
      var search = wb.getSearch();           
      var prime_id= "client_id:"+search.grid.cells(search.grid.getSelectedId(),0).getValue();
  ...
  //wb.setGridDelCallback(doDeleteWithoutForm)   ;  
    ...
    //search should be updated by the developer depend on the req
       var mySearchColumns = [
          ...
          {type:"text", name: 'client_name', id: 'client_name', placeholder: 'client_name!',size: '10',index: 2 }
