<?php
		 ...
		 *
		 * @package			HOF\view\spo_userrecommend_friend_wb
		 * @version			1.0
		 * @uses
		 * @see
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_userrecommend_friend table and 
		 ...
		 * @modification
		 */
class spo_userrecommend_friend_wb{
...
$log_create->set_otherDetails(array('Mode'=>'spo_userrecommend_friend_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_userrecommend_friend/index/false/0/0/spo_userrecommend_friend_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_userrecommend_friend/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_userrecommend_friend/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_userrecommend_friend/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_userrecommend_friend/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_userrecommend_friend/delete/';
  ...
  var doDeleteForm = function (){ 
   ...
   var doDelete = function (){
      ...
      var search = wb.getSearch();           
      var prime_id= "recommend_id:"+search.grid.cells(search.grid.getSelectedId(),0).getValue();
  ...
  //wb.setGridDelCallback(doDeleteWithoutForm)   ;  
    ...
    //search should be updated by the developer depend on the req
       var mySearchColumns = [
          ...
          {type:"text", name: 'name', id: 'name', placeholder: 'name!',size: '10',index: 2 }
