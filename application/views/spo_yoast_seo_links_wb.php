<?php
		 ...
		 *
		 * @package			HOF\view\spo_yoast_seo_links_wb
		 * @version			1.0
		 * @uses
		 * @see
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_yoast_seo_links table and 
...
$log_create->set_otherDetails(array('Mode'=>'spo_yoast_seo_links_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_yoast_seo_links/index/false/0/0/spo_yoast_seo_links_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_yoast_seo_links/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_yoast_seo_links/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_yoast_seo_links/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_yoast_seo_links/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_yoast_seo_links/delete/';
  ...
  //wb.setGridDelCallback(doDeleteWithoutForm)   ;  
    ...
    //search should be updated by the developer depend on the req
       var mySearchColumns = [
          ...
          {type:"text", name: 'url', id: 'url', placeholder: 'url!',size: '10',index: 2 }
