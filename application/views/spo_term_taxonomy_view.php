<?php
		 ...
		 *
		 *
		 * This is main view file of spo_term_taxonomy management. 
		 *
		 * @package			HOF\view\spo_term_taxonomy_view
		 * @version			1.0
		 * @uses
		 * @see
...
$log_create->set_otherDetails(array('Mode'=>'spo_term_taxonomy_View','Data'=>'-'));
$log_create->init();
...
function createdataGrid(griddiv) {
	...
	dataGrid.setHeader(",,,,,");
	dataGrid.setInitWidths("75,75,75,75,75,75");
	dataGrid.setEditable("false,false,false,false,false,false");
