<?php
		 ...
		 *
		 * @package			HOF\view\spo_hof_banners_wb
		 * @version			1.0
		 * @uses
		 * @see
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_hof_banners table and 
...
$log_create->set_otherDetails(array('Mode'=>'spo_hof_banners_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_hof_banners/index/false/0/0/spo_hof_banners_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_hof_banners/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_hof_banners/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_hof_banners/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_hof_banners/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_hof_banners/delete/';
  ...
  var doDeleteForm = function (){ 
   ...
   var doDelete = function (){
      ...
      var search = wb.getSearch();           
      var prime_id= "banner_id:"+search.grid.cells(search.grid.getSelectedId(),0).getValue();
  ...
  //wb.setGridDelCallback(doDeleteWithoutForm)   ;  
    ...
    //search should be updated by the developer depend on the req
       var mySearchColumns = [
          ...
          {type:"text", name: 'hof_review_id', id: 'hof_review_id', placeholder: 'hof_review_id!',size: '10',index: 2 }
