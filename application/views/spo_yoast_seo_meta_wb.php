<?php
		 ...
		 *
		 * @package			HOF\view\spo_yoast_seo_meta_wb
		 * @version			1.0
		 * @uses
		 * @see
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_yoast_seo_meta table and 
...
$log_create->set_otherDetails(array('Mode'=>'spo_yoast_seo_meta_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_yoast_seo_meta/index/false/0/0/spo_yoast_seo_meta_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_yoast_seo_meta/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_yoast_seo_meta/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_yoast_seo_meta/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_yoast_seo_meta/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_yoast_seo_meta/delete/';
  ...
  var doDeleteForm = function (){ 
   ...
   var doDelete = function (){
      ...
      var search = wb.getSearch();           
      var prime_id= "object_id:"+search.grid.cells(search.grid.getSelectedId(),0).getValue();
  ...
  //wb.setGridDelCallback(doDeleteWithoutForm)   ;  
    ...
    //search should be updated by the developer depend on the req
       var mySearchColumns = [
          ...
          {type:"text", name: 'incoming_link_count', id: 'incoming_link_count', placeholder: 'incoming_link_count!',size: '10',index: 2 }
