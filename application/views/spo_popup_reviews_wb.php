<?php
		 ...
		 *
		 * @package			HOF\view\spo_popup_reviews_wb
		 * @version			1.0
		 * @uses
		 * @see
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_popup_reviews table and 
...
$log_create->set_otherDetails(array('Mode'=>'spo_popup_reviews_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_popup_reviews/index/false/0/0/spo_popup_reviews_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_popup_reviews/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_popup_reviews/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_popup_reviews/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_popup_reviews/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_popup_reviews/delete/';
  ...
  //wb.setGridDelCallback(doDeleteWithoutForm)   ;  
    ...
    //search should be updated by the developer depend on the req
       var mySearchColumns = [
          ...
          {type:"text", name: 'id', id: 'id', placeholder: 'id!',size: '10',index: 2 }
