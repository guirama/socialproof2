<?php
		 ...
		 *
		 * @package			HOF\view\spo_client_preferences_wb
		 * @version			1.0
		 * @uses
		 * @see
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_client_preferences table and 
		 ...
		 * @modification
		 */
class spo_client_preferences_wb{
...
$log_create->set_otherDetails(array('Mode'=>'spo_client_preferences_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_client_preferences/index/false/0/0/spo_client_preferences_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_client_preferences/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_client_preferences/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_client_preferences/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_client_preferences/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_client_preferences/delete/';
  ...
  var doDeleteForm = function (){ 
   ...
   var doDelete = function (){
      ...
      var search = wb.getSearch();           
      var prime_id= "pref_id:"+search.grid.cells(search.grid.getSelectedId(),0).getValue();
  ...
  //wb.setGridDelCallback(doDeleteWithoutForm)   ;  
    ...
    //search should be updated by the developer depend on the req
       var mySearchColumns = [
          ...
          {type:"text", name: 'bg_color', id: 'bg_color', placeholder: 'bg_color!',size: '10',index: 2 }
