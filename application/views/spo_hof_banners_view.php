<?php
		 ...
		 *
		 *
		 * This is main view file of spo_hof_banners management. 
		 *
		 * @package			HOF\view\spo_hof_banners_view
		 * @version			1.0
		 * @uses
		 * @see
...
$log_create->set_otherDetails(array('Mode'=>'spo_hof_banners_View','Data'=>'-'));
$log_create->init();
