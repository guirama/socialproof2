<?php
		 ...
		 *
		 * @package			HOF\view\spo_options_wb
		 * @version			1.0
		 * @uses
		 * @see
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_options table and 
...
$log_create->set_otherDetails(array('Mode'=>'spo_options_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_options/index/false/0/0/spo_options_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_options/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_options/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_options/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_options/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_options/delete/';
  ...
  var doDeleteForm = function (){ 
   ...
   var doDelete = function (){
      ...
      var search = wb.getSearch();           
      var prime_id= "option_id:"+search.grid.cells(search.grid.getSelectedId(),0).getValue();
  ...
  //wb.setGridDelCallback(doDeleteWithoutForm)   ;  
    ...
    //search should be updated by the developer depend on the req
       var mySearchColumns = [
          ...
          {type:"text", name: 'option_name', id: 'option_name', placeholder: 'option_name!',size: '10',index: 2 }
