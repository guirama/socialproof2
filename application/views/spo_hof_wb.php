<?php
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_hof table and 
...
$log_create->set_otherDetails(array('Mode'=>'spo_hof_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_hof/index/false/0/0/spo_hof_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_hof/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_hof/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_hof/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_hof/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_hof/delete/';
  ...
  var doDeleteForm = function (){ 
   ...
   var doDelete = function (){
      ...
      var search = wb.getSearch();           
      var prime_id= "hof_id:"+search.grid.cells(search.grid.getSelectedId(),0).getValue();
  ...
  //wb.setGridDelCallback(doDeleteWithoutForm)   ;  
    ...
    //search should be updated by the developer depend on the req
       var mySearchColumns = [
          ...
          {type:"text", name: 'dfm_id', id: 'dfm_id', placeholder: 'dfm_id!',size: '10',index: 2 }
