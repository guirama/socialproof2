<?php
		 ...
		 *
		 *
		 * This is main view file of spo_client_preferences management. 
		 *
		 * @package			HOF\view\spo_client_preferences_view
		 * @version			1.0
		 * @uses
		 * @see
		 ...
		 * @modification
		 */
class spo_client_preferences_view{
...
$log_create->set_otherDetails(array('Mode'=>'spo_client_preferences_View','Data'=>'-'));
$log_create->init();
...
function createdataGrid(griddiv) {
	...
	dataGrid.setHeader(",,,,,,,,");
	dataGrid.setInitWidths("75,75,75,75,75,75,75,75,75");
	dataGrid.setEditable("false,false,false,false,false,false,false,false,false");
