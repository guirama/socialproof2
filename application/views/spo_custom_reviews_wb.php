<?php
		 ...
		 *
		 * @package			HOF\view\spo_custom_reviews_wb
		 * @version			1.0
		 * @uses
		 * @see
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_custom_reviews table and 
...
$log_create->set_otherDetails(array('Mode'=>'spo_custom_reviews_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_custom_reviews/index/false/0/0/spo_custom_reviews_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_custom_reviews/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_custom_reviews/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_custom_reviews/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_custom_reviews/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_custom_reviews/delete/';
  ...
  var doDeleteForm = function (){ 
   ...
   var doDelete = function (){
      ...
      var search = wb.getSearch();           
      var prime_id= "review_id:"+search.grid.cells(search.grid.getSelectedId(),0).getValue();
  ...
  //wb.setGridDelCallback(doDeleteWithoutForm)   ;  
    ...
    //search should be updated by the developer depend on the req
       var mySearchColumns = [
          ...
          {type:"text", name: 'reviewer_name', id: 'reviewer_name', placeholder: 'reviewer_name!',size: '10',index: 2 }
