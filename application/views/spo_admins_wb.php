<?php
		 ...
		 *
		 * @package			HOF\view\spo_admins_wb
		 * @version			1.0
		 * @uses
		 * @see
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_admins table and 
...
$log_create->set_otherDetails(array('Mode'=>'spo_admins_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_admins/index/false/0/0/spo_admins_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_admins/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_admins/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_admins/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_admins/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_admins/delete/';
  ...
  var doDeleteForm = function (){ 
   ...
   var doDelete = function (){
      ...
      var search = wb.getSearch();           
      var prime_id= "admin_id:"+search.grid.cells(search.grid.getSelectedId(),0).getValue();
  ...
  //wb.setGridDelCallback(doDeleteWithoutForm)   ;  
    ...
    //search should be updated by the developer depend on the req
       var mySearchColumns = [
          ...
          {type:"text", name: 'admin_name', id: 'admin_name', placeholder: 'admin_name!',size: '10',index: 2 }
