<?php
		 ...
		 *
		 * @package			HOF\view\spo_custom_reviews_form 
		 * @version			1.0
		 * @uses
		 * @see
...
$reviewer_phone = isset($reviewer_phone)? $reviewer_phone: "";
...
$log_create->set_otherDetails(array('Mode'=>"spo_custom_reviews_Form-$mode",'Data'=>$review_id));
$log_create->init();


$fieldset_title ="Spo_custom_reviews (".ucfirst($mode).")";
?>
...
<?
//Create new form
$myForm = new form_object('spo_custom_reviews_form') ;
...
$field_9 = new field(
	...
	$myForm->fieldSets = array(
			'tpdetails' => array(
					...
					'fields' =>  array(
							$id_field,
							$mode_field,$form_status_field,$field_0,$field_1,$field_2,$field_3,$field_4,$field_5,$field_6,$field_7,$field_8,$field_9
							)
					)
	);
$myForm->init();
...
function inputValidate(){
	...
	idlist = Array('review_id','user_id','rating','reviewer_name','reviewer_email','reviewer_phone','review','provider_name','profile_link','created_on');
	iddis = Array('','','','','','','','','','');
