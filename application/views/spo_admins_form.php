<?php
		 ...
		 *
		 * @package			HOF\view\spo_admins_form 
		 * @version			1.0
		 * @uses
		 * @see
...
$log_create->set_otherDetails(array('Mode'=>"spo_admins_Form-$mode",'Data'=>$admin_id));
$log_create->init();


$fieldset_title ="Spo_admins (".ucfirst($mode).")";
?>
...
<?
//Create new form
$myForm = new form_object('spo_admins_form') ;
	...
	$myForm->formOpenTag = array('method' => 'post',
		...
		$id_field = new field('admin_id','hidden',array('value'=>$admin_id,'required_mark' => false));
...
function inputValidate(){
	...
	idlist = Array('admin_id','admin_name','username','password','email');
	iddis = Array('','','','','');
