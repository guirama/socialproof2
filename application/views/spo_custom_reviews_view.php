<?php
		 ...
		 *
		 *
		 * This is main view file of spo_custom_reviews management. 
		 *
		 * @package			HOF\view\spo_custom_reviews_view
		 * @version			1.0
		 * @uses
		 * @see
...
$log_create->set_otherDetails(array('Mode'=>'spo_custom_reviews_View','Data'=>'-'));
$log_create->init();
...
function createdataGrid(griddiv) {
	...
	dataGrid.setHeader(",,,,,,,,,");
	dataGrid.setInitWidths("75,75,75,75,75,75,75,75,75,75");
	dataGrid.setEditable("false,false,false,false,false,false,false,false,false,false");
