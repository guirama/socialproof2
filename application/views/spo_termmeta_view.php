<?php
		 ...
		 *
		 *
		 * This is main view file of spo_termmeta management. 
		 *
		 * @package			HOF\view\spo_termmeta_view
		 * @version			1.0
		 * @uses
		 * @see
...
$log_create->set_otherDetails(array('Mode'=>'spo_termmeta_View','Data'=>'-'));
$log_create->init();
