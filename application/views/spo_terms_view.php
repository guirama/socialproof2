<?php
		 ...
		 *
		 *
		 * This is main view file of spo_terms management. 
		 *
		 * @package			HOF\view\spo_terms_view
		 * @version			1.0
		 * @uses
		 * @see
...
$log_create->set_otherDetails(array('Mode'=>'spo_terms_View','Data'=>'-'));
$log_create->init();
