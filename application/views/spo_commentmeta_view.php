<?php
		 ...
		 *
		 *
		 * This is main view file of spo_commentmeta management. 
		 *
		 * @package			HOF\view\spo_commentmeta_view
		 * @version			1.0
		 * @uses
		 * @see
...
$log_create->set_otherDetails(array('Mode'=>'spo_commentmeta_View','Data'=>'-'));
$log_create->init();
