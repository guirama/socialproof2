<?php
		 ...
		 *
		 *
		 * This is main view file of spo_client_reviews management. 
		 *
		 * @package			HOF\view\spo_client_reviews_view
		 * @version			1.0
		 * @uses
		 * @see
...
$log_create->set_otherDetails(array('Mode'=>'spo_client_reviews_View','Data'=>'-'));
$log_create->init();
