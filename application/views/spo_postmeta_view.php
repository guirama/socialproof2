<?php
		 ...
		 *
		 *
		 * This is main view file of spo_postmeta management. 
		 *
		 * @package			HOF\view\spo_postmeta_view
		 * @version			1.0
		 * @uses
		 * @see
...
$log_create->set_otherDetails(array('Mode'=>'spo_postmeta_View','Data'=>'-'));
$log_create->init();
