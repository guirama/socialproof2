<?php
		 ...
		 *
		 *
		 * This is main view file of spo_yoast_seo_links management. 
		 *
		 * @package			HOF\view\spo_yoast_seo_links_view
		 * @version			1.0
		 * @uses
		 * @see
		 ...
		 * @modification
		 */
class spo_yoast_seo_links_view{
...
$log_create->set_otherDetails(array('Mode'=>'spo_yoast_seo_links_View','Data'=>'-'));
$log_create->init();
...
function createdataGrid(griddiv) {
	...
	dataGrid.setHeader(",,,,");
	dataGrid.setInitWidths("75,75,75,75,75");
	dataGrid.setEditable("false,false,false,false,false");
