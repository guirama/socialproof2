<?php
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_posts table and 
...
$log_create->set_otherDetails(array('Mode'=>'spo_posts_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_posts/index/false/0/0/spo_posts_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_posts/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_posts/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_posts/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_posts/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_posts/delete/';
  ...
  //wb.setGridDelCallback(doDeleteWithoutForm)   ;  
    ...
    //search should be updated by the developer depend on the req
       var mySearchColumns = [
          ...
          {type:"text", name: 'post_status', id: 'post_status', placeholder: 'post_status!',size: '10',index: 2 }
