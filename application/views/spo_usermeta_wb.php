<?php
		 ...
		 *
		 * @package			HOF\view\spo_usermeta_wb
		 * @version			1.0
		 * @uses
		 * @see
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_usermeta table and 
...
$log_create->set_otherDetails(array('Mode'=>'spo_usermeta_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_usermeta/index/false/0/0/spo_usermeta_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_usermeta/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_usermeta/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_usermeta/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_usermeta/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_usermeta/delete/';
  ...
  var doDeleteForm = function (){ 
   ...
   var doDelete = function (){
      ...
      var search = wb.getSearch();           
      var prime_id= "umeta_id:"+search.grid.cells(search.grid.getSelectedId(),0).getValue();
