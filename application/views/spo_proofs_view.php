<?php
		 ...
		 *
		 *
		 * This is main view file of spo_proofs management. 
		 *
		 * @package			HOF\view\spo_proofs_view
		 * @version			1.0
		 * @uses
		 * @see
...
$log_create->set_otherDetails(array('Mode'=>'spo_proofs_View','Data'=>'-'));
$log_create->init();
