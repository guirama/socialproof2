...
$hof_id	= isset($hof_id)? $hof_id : "";
$hof_id = isset($hof_id)? $hof_id: "";
$user_id = isset($user_id)? $user_id: "";
$gmr_id = isset($gmr_id)? $gmr_id: "";
$dfm_id = isset($dfm_id)? $dfm_id: "";
...
$log_create->set_otherDetails(array('Mode'=>"spo_hof_Form-$mode",'Data'=>$hof_id));
$log_create->init();


$fieldset_title ="Spo_hof (".ucfirst($mode).")";
?>
...
<?
//Create new form
$myForm = new form_object('spo_hof_form') ;
	...
	$myForm->formOpenTag = array('method' => 'post',
		...
		$id_field = new field('hof_id','hidden',array('value'=>$hof_id,'required_mark' => false));
...
function inputValidate(){
	...
	idlist = Array('hof_id','user_id','gmr_id','dfm_id');
	iddis = Array('','','','');
