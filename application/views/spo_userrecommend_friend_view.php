<?php
		 ...
		 *
		 *
		 * This is main view file of spo_userrecommend_friend management. 
		 *
		 * @package			HOF\view\spo_userrecommend_friend_view
		 * @version			1.0
		 * @uses
		 * @see
		 ...
		 * @modification
		 */
class spo_userrecommend_friend_view{
...
$log_create->set_otherDetails(array('Mode'=>'spo_userrecommend_friend_View','Data'=>'-'));
$log_create->init();
...
function createdataGrid(griddiv) {
	...
	dataGrid.setHeader(",,,,,,,");
	dataGrid.setInitWidths("75,75,75,75,75,75,75,75");
	dataGrid.setEditable("false,false,false,false,false,false,false,false");
