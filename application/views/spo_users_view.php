<?php
		 ...
		 *
		 *
		 * This is main view file of spo_users management. 
		 *
		 * @package			HOF\view\spo_users_view
		 * @version			1.0
		 * @uses
		 * @see
...
$log_create->set_otherDetails(array('Mode'=>'spo_users_View','Data'=>'-'));
$log_create->init();
