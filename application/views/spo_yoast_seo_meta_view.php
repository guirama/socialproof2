<?php
		 ...
		 *
		 *
		 * This is main view file of spo_yoast_seo_meta management. 
		 *
		 * @package			HOF\view\spo_yoast_seo_meta_view
		 * @version			1.0
		 * @uses
		 * @see
...
$log_create->set_otherDetails(array('Mode'=>'spo_yoast_seo_meta_View','Data'=>'-'));
$log_create->init();
