<?php
		 ...
		 *
		 * @package			HOF\view\spo_commentmeta_wb
		 * @version			1.0
		 * @uses
		 * @see
		...
		/**
	 	 *  This is the work bench implementaion script
	 	 *	
	 	 *	This script creates an instnce of the work bench object for spo_commentmeta table and 
...
$log_create->set_otherDetails(array('Mode'=>'spo_commentmeta_WB','Data'=>'-'));
$log_create->init();
...
//-------------------------------
       ...
       wb.url = '<?php echo base_url()?>index.php/spo_commentmeta/index/false/0/0/spo_commentmeta_view/XML/';
       
  	   wb.gridreloadurl = '<?php echo base_url()?>index.php/spo_commentmeta/index/true/0/0/data_feed_template/XML/';
       ...
       wb.formUrl = '<?php echo base_url()?>index.php/spo_commentmeta/loadForm/';
       wb.formdataUrl = '<?php echo base_url()?>index.php/spo_commentmeta/data_form/';
       wb.formDataUrl = '<?php echo base_url()?>index.php/spo_commentmeta/save/';
       wb.formDelUrl = '<?php echo base_url()?>index.php/spo_commentmeta/delete/';
  ...
  var doDeleteForm = function (){ 
   ...
   var doDelete = function (){
      ...
      var search = wb.getSearch();           
      var prime_id= "meta_id:"+search.grid.cells(search.grid.getSelectedId(),0).getValue();
  ...
  //wb.setGridDelCallback(doDeleteWithoutForm)   ;  
    ...
    //search should be updated by the developer depend on the req
       var mySearchColumns = [
          ...
          {type:"text", name: 'meta_key', id: 'meta_key', placeholder: 'meta_key!',size: '10',index: 2 }
