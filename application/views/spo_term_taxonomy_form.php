<?php
		 ...
		 *
		 * @package			HOF\view\spo_term_taxonomy_form 
		 * @version			1.0
		 * @uses
		 * @see
...
$log_create->set_otherDetails(array('Mode'=>"spo_term_taxonomy_Form-$mode",'Data'=>$term_taxonomy_id));
$log_create->init();


$fieldset_title ="Spo_term_taxonomy (".ucfirst($mode).")";
?>
...
<?
//Create new form
$myForm = new form_object('spo_term_taxonomy_form') ;
	...
	$myForm->formOpenTag = array('method' => 'post',
		...
		$id_field = new field('term_taxonomy_id','hidden',array('value'=>$term_taxonomy_id,'required_mark' => false));
...
$field_5 = new field(
	...
	$myForm->fieldSets = array(
			'tpdetails' => array(
					...
					'fields' =>  array(
							$id_field,
							$mode_field,$form_status_field,$field_0,$field_1,$field_2,$field_3,$field_4,$field_5
							)
					)
	);
$myForm->init();
...
function inputValidate(){
	...
	idlist = Array('term_taxonomy_id','term_id','taxonomy','description','parent','count');
	iddis = Array('','','','','','');
