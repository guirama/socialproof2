<?php
		/**
		 * This is model developed to maintain table spo_popup_reviews
		 *
		 * @package    HOF\models\spo_popup_reviews
		 * @version    1.0
		 ...
		 *  @modification 	 
		 */
class  Spo_popup_reviews_model extends CI_Model
{
	/**
...
$this->metadata_array['PK']= 'review_id';

$this->metadata_array['review_id']['header']= '';

$this->metadata_array['review_id']['type']= 'int';

$this->metadata_array['review_id']['width']='11';

$this->metadata_array['id']['header']= '';

$this->metadata_array['id']['type']= 'varchar';

$this->metadata_array['id']['width']='150';
...
$this->metadata_array['rating']['header']= '';

$this->metadata_array['rating']['type']= 'int';

$this->metadata_array['rating']['width']='11';

$this->metadata_array['reviewer_name']['header']= '';

$this->metadata_array['reviewer_name']['type']= 'varchar';

$this->metadata_array['reviewer_name']['width']='255';

$this->metadata_array['reviewer_email']['header']= '';

$this->metadata_array['reviewer_email']['type']= 'varchar';

$this->metadata_array['reviewer_email']['width']='255';

$this->metadata_array['reviewer_image']['header']= '';

$this->metadata_array['reviewer_image']['type']= 'varchar';

$this->metadata_array['reviewer_image']['width']='255';

$this->metadata_array['review']['header']= '';

$this->metadata_array['review']['type']= 'text';

$this->metadata_array['review']['width']='';

$this->metadata_array['provider_name']['header']= '';

$this->metadata_array['provider_name']['type']= 'varchar';

$this->metadata_array['provider_name']['width']='255';

$this->metadata_array['profile_link']['header']= '';

$this->metadata_array['profile_link']['type']= 'varchar';

$this->metadata_array['profile_link']['width']='255';

$this->metadata_array['created_on']['header']= '';

$this->metadata_array['created_on']['type']= 'date';

$this->metadata_array['created_on']['width']='';

$this->metadata_array['approved']['header']= '';

$this->metadata_array['approved']['type']= 'int';

$this->metadata_array['approved']['width']='11';

		
		$metadata = $this->db->field_data('spo_popup_reviews') ;
	...
	{
		$this->db->from('spo_popup_reviews');
	...
	function exists_column($column){
		return $this->db->field_exists($column,'spo_popup_reviews');
	}
	...
	private function getHeader($data){
		...
		$selection =  isset($data['selection'])? $data['selection']: 'spo_popup_reviews.review_id,spo_popup_reviews.id,spo_popup_reviews.user_id,spo_popup_reviews.rating,spo_popup_reviews.reviewer_name,spo_popup_reviews.reviewer_email,spo_popup_reviews.reviewer_image,spo_popup_reviews.review,spo_popup_reviews.provider_name,spo_popup_reviews.profile_link,spo_popup_reviews.created_on,spo_popup_reviews.approved' ;
	...
	function set_query($data,$limit_enable){
		...
		$search_filter="";
		$data['selection'] =  isset($data['selection'])? $data['selection']: 'spo_popup_reviews.review_id,spo_popup_reviews.id,spo_popup_reviews.user_id,spo_popup_reviews.rating,spo_popup_reviews.reviewer_name,spo_popup_reviews.reviewer_email,spo_popup_reviews.reviewer_image,spo_popup_reviews.review,spo_popup_reviews.provider_name,spo_popup_reviews.profile_link,spo_popup_reviews.created_on,spo_popup_reviews.approved';
	...
	function save(&$data_array,$key=false)
	{
		...
		if (!$key or !$this->exists($key))
			...
			if($this->db->insert('spo_popup_reviews'))
			{
					return true;
			...
			if($this->db->update('spo_popup_reviews')){
				return true;
	...
	function delete($pks)
	{
		 if (!isset($_SESSION['user_name'])){
			...
			$this->db->where($pks);
			return $this->db->delete('spo_popup_reviews');
		 }
 	}
