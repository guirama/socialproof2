<?php
		/**
		 * This is model developed to maintain table spo_comments
		 *
		 * @package    HOF\models\spo_comments
		 * @version    1.0
		 ...
		 *  @modification 	 
		 */
class  Spo_comments_model extends CI_Model
{
	/**
...
$this->metadata_array['PK']= 'comment_ID';

$this->metadata_array['comment_ID']['header']= '';

$this->metadata_array['comment_ID']['type']= 'bigint';

$this->metadata_array['comment_ID']['width']='20 unsigned';

$this->metadata_array['comment_post_ID']['header']= '';

$this->metadata_array['comment_post_ID']['type']= 'bigint';

$this->metadata_array['comment_post_ID']['width']='20 unsigned';

$this->metadata_array['comment_author']['header']= '';

$this->metadata_array['comment_author']['type']= 'tinytext';

$this->metadata_array['comment_author']['width']='';

$this->metadata_array['comment_author_email']['header']= '';

$this->metadata_array['comment_author_email']['type']= 'varchar';

$this->metadata_array['comment_author_email']['width']='100';

$this->metadata_array['comment_author_url']['header']= '';

$this->metadata_array['comment_author_url']['type']= 'varchar';

$this->metadata_array['comment_author_url']['width']='200';

$this->metadata_array['comment_author_IP']['header']= '';

$this->metadata_array['comment_author_IP']['type']= 'varchar';

$this->metadata_array['comment_author_IP']['width']='100';

$this->metadata_array['comment_date']['header']= '';

$this->metadata_array['comment_date']['type']= 'datetime';

$this->metadata_array['comment_date']['width']='';

$this->metadata_array['comment_date_gmt']['header']= '';

$this->metadata_array['comment_date_gmt']['type']= 'datetime';

$this->metadata_array['comment_date_gmt']['width']='';

$this->metadata_array['comment_content']['header']= '';

$this->metadata_array['comment_content']['type']= 'text';

$this->metadata_array['comment_content']['width']='';

$this->metadata_array['comment_karma']['header']= '';

$this->metadata_array['comment_karma']['type']= 'int';

$this->metadata_array['comment_karma']['width']='11';

$this->metadata_array['comment_approved']['header']= '';

$this->metadata_array['comment_approved']['type']= 'varchar';

$this->metadata_array['comment_approved']['width']='20';

$this->metadata_array['comment_agent']['header']= '';

$this->metadata_array['comment_agent']['type']= 'varchar';

$this->metadata_array['comment_agent']['width']='255';

$this->metadata_array['comment_type']['header']= '';

$this->metadata_array['comment_type']['type']= 'varchar';

$this->metadata_array['comment_type']['width']='20';

$this->metadata_array['comment_parent']['header']= '';

$this->metadata_array['comment_parent']['type']= 'bigint';

$this->metadata_array['comment_parent']['width']='20 unsigned';

$this->metadata_array['user_id']['header']= '';

$this->metadata_array['user_id']['type']= 'bigint';

$this->metadata_array['user_id']['width']='20 unsigned';

		
		$metadata = $this->db->field_data('spo_comments') ;
	...
	function exists_column($column){
		return $this->db->field_exists($column,'spo_comments');
	}
	...
	private function getHeader($data){
		...
		$selection =  isset($data['selection'])? $data['selection']: 'spo_comments.comment_ID,spo_comments.comment_post_ID,spo_comments.comment_author,spo_comments.comment_author_email,spo_comments.comment_author_url,spo_comments.comment_author_IP,spo_comments.comment_date,spo_comments.comment_date_gmt,spo_comments.comment_content,spo_comments.comment_karma,spo_comments.comment_approved,spo_comments.comment_agent,spo_comments.comment_type,spo_comments.comment_parent,spo_comments.user_id' ;
	...
	function set_query($data,$limit_enable){
		...
		$search_filter="";
		$data['selection'] =  isset($data['selection'])? $data['selection']: 'spo_comments.comment_ID,spo_comments.comment_post_ID,spo_comments.comment_author,spo_comments.comment_author_email,spo_comments.comment_author_url,spo_comments.comment_author_IP,spo_comments.comment_date,spo_comments.comment_date_gmt,spo_comments.comment_content,spo_comments.comment_karma,spo_comments.comment_approved,spo_comments.comment_agent,spo_comments.comment_type,spo_comments.comment_parent,spo_comments.user_id';
	...
	function save(&$data_array,$key=false)
	{
		...
		if (!$key or !$this->exists($key))
			...
			if($this->db->insert('spo_comments'))
			{
					return true;
			...
			if($this->db->update('spo_comments')){
				return true;
	...
	function delete($pks)
	{
		 if (!isset($_SESSION['user_name'])){
			...
			$this->db->where($pks);
			return $this->db->delete('spo_comments');
		 }
 	}
