<?php
		/**
		 * This is model developed to maintain table spo_userrecommend_friend
		 *
		 * @package    HOF\models\spo_userrecommend_friend
		 * @version    1.0
		 ...
		 *  @modification 	 
		 */
class  Spo_userrecommend_friend_model extends CI_Model
{
	/**
...
$this->metadata_array['PK']= 'recommend_id';

$this->metadata_array['recommend_id']['header']= '';

$this->metadata_array['recommend_id']['type']= 'int';

$this->metadata_array['recommend_id']['width']='11';
...
$this->metadata_array['name']['header']= '';

$this->metadata_array['name']['type']= 'varchar';

$this->metadata_array['name']['width']='255';

$this->metadata_array['friend_name']['header']= '';

$this->metadata_array['friend_name']['type']= 'varchar';

$this->metadata_array['friend_name']['width']='255';

$this->metadata_array['friend_email']['header']= '';

$this->metadata_array['friend_email']['type']= 'varchar';

$this->metadata_array['friend_email']['width']='255';

$this->metadata_array['friend_mobile']['header']= '';

$this->metadata_array['friend_mobile']['type']= 'varchar';

$this->metadata_array['friend_mobile']['width']='255';

$this->metadata_array['ip']['header']= '';

$this->metadata_array['ip']['type']= 'varchar';

$this->metadata_array['ip']['width']='255';

$this->metadata_array['date']['header']= '';

$this->metadata_array['date']['type']= 'date';

$this->metadata_array['date']['width']='';

		
		$metadata = $this->db->field_data('spo_userrecommend_friend') ;
	...
	{
		$this->db->from('spo_userrecommend_friend');
	...
	function exists_column($column){
		return $this->db->field_exists($column,'spo_userrecommend_friend');
	}
	...
	private function getHeader($data){
		...
		$selection =  isset($data['selection'])? $data['selection']: 'spo_userrecommend_friend.recommend_id,spo_userrecommend_friend.user_id,spo_userrecommend_friend.name,spo_userrecommend_friend.friend_name,spo_userrecommend_friend.friend_email,spo_userrecommend_friend.friend_mobile,spo_userrecommend_friend.ip,spo_userrecommend_friend.date' ;
	...
	function set_query($data,$limit_enable){
		...
		$search_filter="";
		$data['selection'] =  isset($data['selection'])? $data['selection']: 'spo_userrecommend_friend.recommend_id,spo_userrecommend_friend.user_id,spo_userrecommend_friend.name,spo_userrecommend_friend.friend_name,spo_userrecommend_friend.friend_email,spo_userrecommend_friend.friend_mobile,spo_userrecommend_friend.ip,spo_userrecommend_friend.date';
	...
	function save(&$data_array,$key=false)
	{
		...
		if (!$key or !$this->exists($key))
			...
			if($this->db->insert('spo_userrecommend_friend'))
			{
					return true;
			...
			if($this->db->update('spo_userrecommend_friend')){
				return true;
	...
	function delete($pks)
	{
		 if (!isset($_SESSION['user_name'])){
			...
			$this->db->where($pks);
			return $this->db->delete('spo_userrecommend_friend');
		 }
 	}
