<?php
		/**
		 * This is model developed to maintain table spo_links
		 *
		 * @package    HOF\models\spo_links
		 * @version    1.0
		 ...
		 *  @modification 	 
		 */
class  Spo_links_model extends CI_Model
{
	/**
...
$this->metadata_array['PK']= 'link_id';

$this->metadata_array['link_id']['header']= '';

$this->metadata_array['link_id']['type']= 'bigint';

$this->metadata_array['link_id']['width']='20 unsigned';

$this->metadata_array['link_url']['header']= '';

$this->metadata_array['link_url']['type']= 'varchar';

$this->metadata_array['link_url']['width']='255';

$this->metadata_array['link_name']['header']= '';

$this->metadata_array['link_name']['type']= 'varchar';

$this->metadata_array['link_name']['width']='255';

$this->metadata_array['link_image']['header']= '';

$this->metadata_array['link_image']['type']= 'varchar';

$this->metadata_array['link_image']['width']='255';

$this->metadata_array['link_target']['header']= '';

$this->metadata_array['link_target']['type']= 'varchar';

$this->metadata_array['link_target']['width']='25';

$this->metadata_array['link_description']['header']= '';

$this->metadata_array['link_description']['type']= 'varchar';

$this->metadata_array['link_description']['width']='255';

$this->metadata_array['link_visible']['header']= '';

$this->metadata_array['link_visible']['type']= 'varchar';

$this->metadata_array['link_visible']['width']='20';

$this->metadata_array['link_owner']['header']= '';

$this->metadata_array['link_owner']['type']= 'bigint';

$this->metadata_array['link_owner']['width']='20 unsigned';

$this->metadata_array['link_rating']['header']= '';

$this->metadata_array['link_rating']['type']= 'int';

$this->metadata_array['link_rating']['width']='11';

$this->metadata_array['link_updated']['header']= '';

$this->metadata_array['link_updated']['type']= 'datetime';

$this->metadata_array['link_updated']['width']='';

$this->metadata_array['link_rel']['header']= '';

$this->metadata_array['link_rel']['type']= 'varchar';

$this->metadata_array['link_rel']['width']='255';

$this->metadata_array['link_notes']['header']= '';

$this->metadata_array['link_notes']['type']= 'mediumtext';

$this->metadata_array['link_notes']['width']='';

$this->metadata_array['link_rss']['header']= '';

$this->metadata_array['link_rss']['type']= 'varchar';

$this->metadata_array['link_rss']['width']='255';

		
		$metadata = $this->db->field_data('spo_links') ;
	...
	function exists_column($column){
		return $this->db->field_exists($column,'spo_links');
	}
	...
	private function getHeader($data){
		...
		$selection =  isset($data['selection'])? $data['selection']: 'spo_links.link_id,spo_links.link_url,spo_links.link_name,spo_links.link_image,spo_links.link_target,spo_links.link_description,spo_links.link_visible,spo_links.link_owner,spo_links.link_rating,spo_links.link_updated,spo_links.link_rel,spo_links.link_notes,spo_links.link_rss' ;
	...
	function set_query($data,$limit_enable){
		...
		$search_filter="";
		$data['selection'] =  isset($data['selection'])? $data['selection']: 'spo_links.link_id,spo_links.link_url,spo_links.link_name,spo_links.link_image,spo_links.link_target,spo_links.link_description,spo_links.link_visible,spo_links.link_owner,spo_links.link_rating,spo_links.link_updated,spo_links.link_rel,spo_links.link_notes,spo_links.link_rss';
	...
	function delete($pks)
	{
		 if (!isset($_SESSION['user_name'])){
			...
			$this->db->where($pks);
			return $this->db->delete('spo_links');
		 }
 	}
