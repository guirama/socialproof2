<?php
		/**
		 * This is model developed to maintain table spo_clients
		 *
		 * @package    HOF\models\spo_clients
		 * @version    1.0
		 ...
		 *  @modification 	 
		 */
class  Spo_clients_model extends CI_Model
{
	/**
...
$this->metadata_array['PK']= 'client_id';
...
$this->metadata_array['client_name']['header']= '';

$this->metadata_array['client_name']['type']= 'varchar';

$this->metadata_array['client_name']['width']='255';

$this->metadata_array['username']['header']= '';

$this->metadata_array['username']['type']= 'varchar';

$this->metadata_array['username']['width']='50';

$this->metadata_array['password']['header']= '';

$this->metadata_array['password']['type']= 'varchar';

$this->metadata_array['password']['width']='255';

$this->metadata_array['practice_name']['header']= '';

$this->metadata_array['practice_name']['type']= 'varchar';

$this->metadata_array['practice_name']['width']='255';

$this->metadata_array['website']['header']= '';

$this->metadata_array['website']['type']= 'varchar';

$this->metadata_array['website']['width']='255';

$this->metadata_array['address']['header']= '';

$this->metadata_array['address']['type']= 'text';

$this->metadata_array['address']['width']='';
...
$this->metadata_array['phone']['width']='255';

$this->metadata_array['gmr_id']['header']= '';

$this->metadata_array['gmr_id']['type']= 'int';

$this->metadata_array['gmr_id']['width']='11';

$this->metadata_array['app_form_id']['header']= '';

$this->metadata_array['app_form_id']['type']= 'varchar';

$this->metadata_array['app_form_id']['width']='255';

$this->metadata_array['call_tracker']['header']= '';

$this->metadata_array['call_tracker']['type']= 'varchar';

$this->metadata_array['call_tracker']['width']='255';

$this->metadata_array['dr_img']['header']= '';

$this->metadata_array['dr_img']['type']= 'varchar';

$this->metadata_array['dr_img']['width']='255';

$this->metadata_array['dr_logo']['header']= '';

$this->metadata_array['dr_logo']['type']= 'varchar';

$this->metadata_array['dr_logo']['width']='255';

		
		$metadata = $this->db->field_data('spo_clients') ;
	...
	function exists_column($column){
		return $this->db->field_exists($column,'spo_clients');
	}
	...
	function set_query($data,$limit_enable){
		...
		$search_filter="";
		$data['selection'] =  isset($data['selection'])? $data['selection']: 'spo_clients.client_id,spo_clients.client_name,spo_clients.username,spo_clients.password,spo_clients.practice_name,spo_clients.website,spo_clients.address,spo_clients.email,spo_clients.phone,spo_clients.gmr_id,spo_clients.app_form_id,spo_clients.call_tracker,spo_clients.dr_img,spo_clients.dr_logo';
	...
	function delete($pks)
	{
		 if (!isset($_SESSION['user_name'])){
			...
			$this->db->where($pks);
			return $this->db->delete('spo_clients');
		 }
 	}
